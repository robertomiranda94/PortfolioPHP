...
Class Content extends DBConnection {
	...
	public function update(){
		...
		if($update){
			...
			$this->settings->set_flashdata("success",ucfirst($file)." Proceso realizado con éxito");
			exit;
		}
	}
	public function education(){
		...
		if($save){
			$resp['status']='success';
			$resp['message']= " Proceso realizado con éxito ".$action;
	...
	public function education_delete(){
		...
		if($qry){
			$resp['status']='success';
			$resp['message']= " Proceso realizado con éxito";
			$this->settings->set_flashdata('success',$resp['message']);
		}
	}
	...
	public function project(){
		...
		$save = $this->conn->query($sql);
		$action = empty($id) ? "Agregado":"Editado";
		if($save){
			$resp['status']='success';
			$resp['message']= " Proceso realizado con éxito ".$action;
			$this->settings->set_flashdata('success',$resp['message']);
