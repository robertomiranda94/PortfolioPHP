...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group col-xs-7">
							<label for="" class="control-label">Comienzo</label>
					...
					<div class="col-sm-6">
						<div class="form-group col-xs-7">
							<label for="" class="control-label">Finalización</label>
						...
						<div class="form-group col-xs-5">
							...
							<br>
							<label for="present"><input type="checkbox" name="present" id="present">Presente</label>
						</div>
					</div>
				</div>
				<div class="row">
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=work">Cancelar</a>
		</div>
	</div>
</div>
