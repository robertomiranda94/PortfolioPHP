...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="education"><?php echo isset($_GET['id']) ? "Editar": "Guardar" ?></button>
			<a class="btn btn-primary btn-sm" href="./?page=education">Cancelar</a>
		</div>
	</div>
</div>
