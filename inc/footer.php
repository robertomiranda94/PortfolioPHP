      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="social-links">
               ...
               <li><a target ="_blank" href="mailto:<?php echo $contact['email'] ?>"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
               <li><a target ="_blank" href="<?php echo $contact['linkin'] ?>"><i class="fa fa-linkedin"></i></a></li>
            </ul>

            <ul class="copyright">
               <li>Portfolio &copy; Copyright 2023</li>
             <li>Creado por <a href="https://www.linkedin.com/in/robertomiranda94/" title="Styleshout" target="_blank">Roberto Miranda</a></li>
            </ul>
